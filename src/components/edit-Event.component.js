...
export default class EditEvent extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5000/Event/" + this.props.match.params.id)
      .then((response) => {
        this.setState({
          ...
          G_Pprice: response.data.G_Pprice,
          S_Pprice: response.data.S_Pprice,
          P_Pprice: response.data.P_Pprice,
        });
      })
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "http://localhost:5000/Event/update/" + this.props.match.params.id,
        Event
      )
